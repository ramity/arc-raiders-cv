...
class ARCCV:
    ...
    def process_vod(self, vod_path):
        ...
        PROCESS_START_FRAME = (20 * 60 * 60) + (31.5 * 60)
    ...
    def _draw_looting_ui(self, frame):
        cv2.rectangle(frame, OVERLAY_NAVIGATION_SUBREGION[:2], (OVERLAY_NAVIGATION_SUBREGION[0] + OVERLAY_NAVIGATION_SUBREGION[2], OVERLAY_NAVIGATION_SUBREGION[1] + OVERLAY_NAVIGATION_SUBREGION[3]), (0, 0, 255), 1)
